...
public class suga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setTitle("SUGA"); // 툴바 제목 설정
        }
        ...
        myRef = FirebaseDatabase.getInstance().getReference().child("member").child("suga");
        ...
        gridView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent = new Intent(suga.this, MemberDetailActivity.class);
            intent.putExtra("userID", "suga");
