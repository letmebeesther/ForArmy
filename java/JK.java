...
public class JK extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef = FirebaseDatabase.getInstance().getReference().child("member").child("JK");
        ...
        gridView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent = new Intent(JK.this, MemberDetailActivity.class);
            intent.putExtra("userID", "JK");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            // 설정 아이콘 클릭 처리
            Intent intent = new Intent(JK.this, ChatActivity.class);
            startActivity(intent);
            return true;
        }
