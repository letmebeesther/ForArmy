...
public class jimin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef = FirebaseDatabase.getInstance().getReference().child("member").child("jimin");
        ...
        gridView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent = new Intent(jimin.this, MemberDetailActivity.class);
            intent.putExtra("userID", "jimin");
