...
public class jin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef = FirebaseDatabase.getInstance().getReference().child("member").child("jin");
        ...
        gridView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent = new Intent(jin.this, MemberDetailActivity.class);
            intent.putExtra("userID", "jin");
