...
public class jhope extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef = FirebaseDatabase.getInstance().getReference().child("member").child("jhope");
        ...
        gridView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent = new Intent(jhope.this, MemberDetailActivity.class);
            intent.putExtra("userID", "jhope");
